...
type LocationServiceClient interface {
	...
	QueryLocations(ctx context.Context, in *QueryLocationsRequest, opts ...grpc.CallOption) (*QueryLocationsResponse, error)
}
...
func (c *locationServiceClient) QueryLocations(ctx context.Context, in *QueryLocationsRequest, opts ...grpc.CallOption) (*QueryLocationsResponse, error) {
	out := new(QueryLocationsResponse)
	err := c.cc.Invoke(ctx, "/protos.location.v1.LocationService/QueryLocations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LocationServiceServer interface {
	...
	QueryLocations(context.Context, *QueryLocationsRequest) (*QueryLocationsResponse, error)
...
func (UnimplementedLocationServiceServer) QueryLocations(context.Context, *QueryLocationsRequest) (*QueryLocationsResponse, error) {
...
func _LocationService_QueryLocations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.location.v1.LocationService/QueryLocations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var LocationService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protos/location/v1/location.proto",
}

...
func (c *detectServiceClient) DetectCrossings(ctx context.Context, in *DetectCrossingsRequest, opts ...grpc.CallOption) (*DetectCrossingsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.location.v1beta1.DetectService/DetectCrossings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DetectService_DetectCrossings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.location.v1beta1.DetectService/DetectCrossings",
	}
...
var DetectService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.location.v1beta1.DetectService",
	...
	Metadata: "api/location/v1beta1/detect.proto",
}

...
type GetAvailableJobsRequest struct {
	...
	WorkerId   string  `protobuf:"bytes,2,opt,name=worker_id,json=workerId,proto3" json:"worker_id,omitempty"`
	LangeLimit float64 `protobuf:"fixed64,3,opt,name=lange_limit,json=langeLimit,proto3" json:"lange_limit,omitempty"`
...
func (x *GetAvailableJobsRequest) GetLangeLimit() float64 {
	if x != nil {
		return x.LangeLimit
	}
	return 0
...
var file_api_job_v1beta1_job_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x6c, 0x61, 0x6e, 0x67, 0x65, 0x5f, 0x6c, 0x69,
	0x6d, 0x69, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0a, 0x6c, 0x61, 0x6e, 0x67, 0x65,

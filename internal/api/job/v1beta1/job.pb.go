...
var file_api_job_v1beta1_job_proto_rawDesc = []byte{
	...
	0x55, 0x50, 0x44, 0x41, 0x54, 0x45, 0x44, 0x10, 0x02, 0x32, 0xb8, 0x01, 0x0a, 0x0a, 0x4a, 0x6f,
...
var file_api_job_v1beta1_job_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_api_job_v1beta1_job_proto_goTypes = []interface{}{
	...
	(*v1beta1.Location)(nil),      // 8: api.type.v1beta1.Location
}
var file_api_job_v1beta1_job_proto_depIdxs = []int32{
	7,  // 0: api.job.v1beta1.JobInfo.created:type_name -> google.protobuf.Timestamp
	7,  // 1: api.job.v1beta1.JobInfo.updated:type_name -> google.protobuf.Timestamp
	7,  // 2: api.job.v1beta1.JobInfo.pickup_date:type_name -> google.protobuf.Timestamp
	8,  // 3: api.job.v1beta1.JobInfo.pickup_loc:type_name -> api.type.v1beta1.Location
	8,  // 4: api.job.v1beta1.JobInfo.dropoff_loc:type_name -> api.type.v1beta1.Location
	...
	2,  // 9: api.job.v1beta1.JobService.ImportJob:input_type -> api.job.v1beta1.ImportJobRequest
	4,  // 10: api.job.v1beta1.JobService.ExportJob:input_type -> api.job.v1beta1.ExportJobRequest
	3,  // 11: api.job.v1beta1.JobService.ImportJob:output_type -> api.job.v1beta1.ImportJobResponse
	6,  // 12: api.job.v1beta1.JobService.ExportJob:output_type -> api.job.v1beta1.ExportJobResponse
